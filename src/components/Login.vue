<template>
  <div class="login-container">
    <el-container>
      ...
      <el-main class="login-body">
        <div class="body-wrap"></div>
          <div class="body-front-wrap">
              <div class="font-wrap">
                <p class="animate" data-ani="bounceInLeft">VKnow新闻后台管理系统 - vknow.com -</p><p class="animate" data-ani="bounceInRight">让科技，改变生活。</p>
              </div>
      ...
      <el-footer class="login-footer">Copyright 2020-2021 vknow.com 版权所有</el-footer>
    </el-container>
  </div>
</template>
